		...
		<div class="row">
			...
			<div class="col-md-3 bg-light py-4">
				...
				<ul class="nav flex-column">
					...
					<li class="nav-item">
						<button class="btn btn-link nav-link" onclick="mostrarSeccion('agregarProducto')">Agregar Productos</button>
					</li>
					<li class="nav-item">
					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<i class="fas fa-edit" style="cursor:pointer; color: blue;" onclick="editarProducto('<%=producto.getId()%>', '<%=producto.getNombre()%>', '<%=producto.getDescripcion()%>', '<%=producto.getPrecio()%>', '<%=producto.getStock()%>')"></i>
									<i class="fas fa-trash-alt" style="cursor:pointer; color: red;" onclick="eliminarProducto('<%=producto.getId()%>')"></i>
								</td>
							</tr>
							<%
								}
					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<i class="fas fa-edit" style="cursor:pointer; color: blue;" onclick="editarUsuario('<%=usuario.getIdUsuario()%>', '<%=usuario.getNombreUsuario()%>', '<%=usuario.getTelefonoUsuario()%>', '<%=usuario.getRol()%>')"></i>
									<i class="fas fa-trash-alt" style="cursor:pointer; color: red;" onclick="eliminarUsuario('<%=usuario.getIdUsuario()%>')"></i>
								</td>
							</tr>
							<%
								}
