...
<div id="modificarProducto" class="seccion" style="display: none;">
    ...
    <form action="modificarProducto" method="post" enctype="multipart/form-data">
        <div class="mb-3">
            ...
            <input type="number" id="idProducto" name="id" class="form-control" required>
        </div>
        <div class="mb-3">
            <label for="nombreProducto" class="form-label">Nombre (opcional):</label>
            <input type="text" id="nombreProducto" name="nombre" class="form-control">
        </div>
        <div class="mb-3">
            <label for="descripcionProducto" class="form-label">Descripción (opcional):</label>
            <textarea id="descripcionProducto" name="descripcion" class="form-control" rows="3"></textarea>
        </div>
        <div class="mb-3">
            <label for="precioProducto" class="form-label">Precio (opcional):</label>
            <input type="number" id="precioProducto" name="precio" class="form-control" step="0.01">
        </div>
        <div class="mb-3">
            <label for="stockProducto" class="form-label">Stock (opcional):</label>
            <input type="number" id="stockProducto" name="stock" class="form-control">
        </div>
        <div class="mb-3">
